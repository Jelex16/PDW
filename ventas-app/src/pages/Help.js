        ...
        <div className="help-container">
            ...
            <div className="help-content">
                <div className="faq-container">
                    <h1 className="help-title">Página de Ayuda</h1>
                    <div>
                        <h2>¿Cómo funciona nuestra tienda?</h2>
                        <p>Nuestra tienda se dedica a ofrecer una amplia variedad de productos de calidad. Puedes navegar por las diferentes categorías de productos y realizar compras seguras en línea.</p>
                        <h2>Contáctanos</h2>
                        <p>Si tienes alguna pregunta adicional o necesitas asistencia personalizada, no dudes en contactarnos a través de nuestro servicio de atención al cliente.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="card-social-container">
                <div className="card-container">
                    <div className="card-header">
                        <div className="text-chat">Comentarios</div>
                    </div>
                    <div className="card-body">
                        <div className="message-input">
                            <form>
                                <textarea placeholder="Escribe tu mensaje aquí" className="message-send"></textarea>
